          ...
          {members.map((member) => (
            <Card key={member.id} className="overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col text-center">
              ...
              <CardContent className="p-6 flex flex-col flex-grow">
                ...
                <Button variant="outline" asChild className="mt-auto w-fit self-center border-primary/50 text-primary hover:bg-primary/10 hover:text-primary"><span><Link to="/members">Read Bio <ArrowRight className="ml-2 h-4 w-4" /></Link></span></Button>
              </CardContent>
            </Card>
          ))}
        </div>
